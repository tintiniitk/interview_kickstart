...
pair<int, int> bubble_sort(ints &arr) {
    ...
    for (int fin = 0; fin < n; ++fin) {
        // cout << "At fin = " << fin << ", arr = \t\t\t" << arr << ", num_swaps
        // = "
        // << num_swaps << ", num_comparisons = " << num_comparisons << endl;
    ...
    // cout << "After final iteration, arr = \t\t" << arr << ", num_swaps = " <<
    // num_swaps << ", num_comparisons = " << num_comparisons << endl;
...
int main(int argc, char *argv[]) {
    ...
    for (auto &[name, arr, expected_num_swaps, expected_num_comparisons] :
         test_cases) {
